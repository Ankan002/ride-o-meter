...
const PickupDropLocationButton = (props: Props) => {
    ...
    return (
        <div className="sm:w-1/3 w-full sm:mx-3 mx-0 my-1 flex flex-row">
            <input className="flex-1 flex px-2 py-1 border-2 rounded-md border-primaryDark/70 font-manrope tracking-wider bg-secondaryLight hover:cursor-pointer text-ellipsis placeholder:text-primaryDark lg:text-xl sm:text-lg text-base" placeholder={placeholder} onClick={onClick} value={text} disabled={true} />
            {
